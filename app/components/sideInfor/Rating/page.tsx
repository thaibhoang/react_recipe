...
const Rating = ({ rating }) => {
  const convertRatingToStars = (ratting) => {
    const partialStar = rating % 1;
    const hasPartialStar = partialStar >= 0.25 && partialStar <= 0.75;
    const fullStars = Math.floor(ratting) + (partialStar > 0.75 ? 1 : 0);
              ...
              {starValue > 0 && starValue < 1 && (
                <defs>
                  ...
                  >
                    ...
                    <stop offset={`${starValue * 100}%`} stopColor="#ffd91a" />
                    <stop
